        ...
        try {
            if (process.env.NODE_ENV === "production") {
                ...
                const mailOptions = {
                    ...
                    subject: `New User Signup - Untanglify`,
                    text: `A User with the username of: ${username}, and the Email of: ${email}, just signed up!`,
                    html: `<h1>New User Alert!</h1><br/><br/><p>A user with the username of <span style="color:#bb86fc">${username}</span> and an email of <span style="color:#bb86fc">${email}</span> just signed up!</p><br/><br/><p>Go email them!</p>`,
                };
...
//# sourceMappingURL=newUserEmail.js.map