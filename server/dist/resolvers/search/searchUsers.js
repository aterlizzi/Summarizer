...
exports.SearchUserResolver = void 0;
const isAuth_1 = require("./../../middlewares/isAuth");
const type_graphql_1 = require("type-graphql");
const User_1 = require("../../entities/User");
const typeorm_1 = require("typeorm");
let SearchUserResolver = class SearchUserResolver {
    searchUsers(username, { payload }) {
...
], SearchUserResolver.prototype, "searchUsers", null);
SearchUserResolver = __decorate([
    (0, type_graphql_1.Resolver)()
], SearchUserResolver);
exports.SearchUserResolver = SearchUserResolver;
